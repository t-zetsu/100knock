...
def main():
    ...
    # 混合行列
    report_train = classification_report(y_train_list, pred_train_list, target_names=['b', 't', "e", "m"])
    report_test = classification_report(y_test_list, pred_test_list, target_names=['b', 't', "e", "m"])
    print("------report (train)------")
    print(report_train,"\n")
    print("------report (test)------")
    print(report_test,"\n")
